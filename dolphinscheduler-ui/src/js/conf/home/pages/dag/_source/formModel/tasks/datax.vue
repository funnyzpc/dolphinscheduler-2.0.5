  ...
  <div class="datax-model">
    ...
    <template v-if="!enable">
      <m-list-box>
        ...
        <div slot="content">
          <m-datasource
            ref="refDs"
            @on-dsData="_onDsData"
            :supportType="['MYSQL','POSTGRESQL', 'ORACLE', 'SQLSERVER', 'CLICKHOUSE','SAPHANA']"
      ...
      <m-list-box>
        ...
        <div slot="content">
          <m-datasource
            ref="refDt"
            @on-dsData="_onDtData"
            :supportType="['MYSQL','POSTGRESQL', 'ORACLE', 'SQLSERVER','SAPHANA']"
      ...
      <m-list-box>
        ...
        <div slot="content">
          <m-select-input v-model="jobSpeedByte" :list="[0,1,10,50,100,512,1024,4096]">
          </m-select-input>
