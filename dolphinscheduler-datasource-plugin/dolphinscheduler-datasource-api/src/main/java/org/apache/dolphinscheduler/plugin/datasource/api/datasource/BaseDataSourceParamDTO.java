...
import org.apache.dolphinscheduler.plugin.datasource.api.datasource.saphana.SapHanaDatasourceParamDTO;
...
@JsonSubTypes(value = {
        ...
        @JsonSubTypes.Type(value = SapHanaDatasourceParamDTO.class, name = "SAPHANA"),
})
