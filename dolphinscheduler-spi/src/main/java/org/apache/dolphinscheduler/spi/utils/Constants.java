...
public class Constants {
    ...
    public static final String COM_SAP_HANA_JDBC_DRIVER = "com.sap.db.jdbc.Driver";
    ...
    public static final String SAPHANA_VALIDATION_QUERY = "select 1 FROM dummy";
    ...
    public static final String JDBC_SAPHANA = "jdbc:sap://";
